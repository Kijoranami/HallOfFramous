...
<div class="container-fluid">
	<form action="" id="post-form">
		...
		<div class="form-group mb-3">
			<label for="caption"  class="control-label">Write something about your image!</label>
			<textarea rows="3" style='background-color:white; border:1px solid white; border-radius:0px' class="form-control form-control-sm" id="caption" name="caption" required="required"><?= isset($caption) ? $caption : '' ?></textarea>
