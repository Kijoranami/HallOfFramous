      ...
      <div class="card rounded-0 shadow">
        <div class="card-body">
          <div class="container-fluid">
            ...
            <div style='background-color:#151515;' class="container-fluid" style="height: 30em !important">
              <?php 
            ...
            <?php else: ?>
            <a href="javascript:void(0)" data-like='false' class="text-reset text-decoration-none like_post" style="margin-right: 2px;" data-id="<?= $row['id'] ?>"><i class="far fa-heart"></i></a>
            <?php endif; ?>
            <span class="like-count font-style-italic" style="margin-right: 12px;"><?= format_num($row['likes']) ?></span>
            <a href="javascript:void(0)" class="text-reset text-decoration-none post_comments" style="margin-right: 2px;" data-id="<?= $row['id'] ?>"><i class="far fa-comment"></i></a>
